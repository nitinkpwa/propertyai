...
export const buyerTokens = {
  ...
  heading: "text-2xl font-bold tracking-tight text-neutral-900 sm:text-3xl",
  ...
  input:
    "w-full rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-3 text-sm text-neutral-900 outline-none transition-all focus:border-emerald-400 focus:bg-white focus:ring-4 focus:ring-emerald-500/10",
} as const;
