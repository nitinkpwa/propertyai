...
import { PROPERTIES_BASE_SELECT } from "@/lib/seller/propertySchema";
...
const PROPERTY_DETAIL_SELECT = `${PROPERTIES_BASE_SELECT}, builder_name, furnishing, parking, facing, nearby_places, rera_number, possession, featured_image, seller:profiles!properties_seller_id_fkey(full_name)`;
