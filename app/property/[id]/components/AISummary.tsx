  ...
  return (
    <SectionCard className="relative overflow-hidden border-emerald-200/60 bg-gradient-to-br from-white via-white to-emerald-50/30">
      ...
      <div className="relative">
        ...
        <p className="rounded-2xl border border-emerald-100/80 bg-white/70 p-4 text-sm leading-relaxed text-body backdrop-blur-sm sm:p-5 sm:text-base sm:leading-7">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {summary.pros.map((pro) => (
                <li key={pro} className="flex items-start gap-2 text-sm text-body">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {summary.cons.map((con) => (
                <li key={con} className="flex items-start gap-2 text-sm text-body">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="flex flex-col justify-center rounded-2xl border border-neutral-100 bg-neutral-50/80 p-4 sm:p-5">
            ...
            {summary.riskLevel ? (
              ...
              <p className="mt-2 text-sm text-muted">Not available yet</p>
            )}
          </div>
        </div>
      </div>
