    ...
    <section className="relative overflow-hidden border-t border-neutral-100 bg-[#F7F9FB] py-16 sm:py-20">
      ...
      <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/ask"
            className="inline-flex min-h-12 w-full items-center justify-center rounded-2xl px-8 text-sm font-bold text-white no-underline shadow-[0_8px_32px_rgba(22,199,132,0.35)] transition-transform hover:scale-[1.02] sm:w-auto"
